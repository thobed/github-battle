...
function Instructions() {
    return (
        <div className='instructions-container'>
            ...
            <ol className='contain-small grid center-text battle-instructions'>
                <li>
        ...
        return (
            <form className='column player' onSubmit={this.handleSubmit}>
                ...
                <div className='row player-inputs'>
                    <input typeof='text' id='username' className='input-light' placeholder='github-username' autoComplete='off' value={this.state.username} onChange={this.handleChange} />
...
export default class Battle extends React.Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <Instructions />
                <div className='plaayers-container'>
                    <h1 className='center-test header-lg'>Players</h1>
